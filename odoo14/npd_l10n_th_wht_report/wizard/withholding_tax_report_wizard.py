...
class WithHoldingTaxReportWizard(models.TransientModel):
    ...
    def _get_report_name(self, report_type):
        ...
        if report_type == "xlsx":
            report_name = "npd_l10n_th_wht_report.report_withholding_tax_xlsx"
        elif report_type == "qweb-text":
            report_name = "npd_l10n_th_wht_report.report_withholding_tax_text"
        else:
            if self.company_id.wht_report_format == "rd" and report_type == "qweb-pdf":
                report_name = "npd_l10n_th_wht_report.report_rd_withholding_tax"
            else:
                report_name = "npd_l10n_th_wht_report.report_withholding_tax"
