...
class AccountJournal(models.Model):
    ...
    sequence_id = fields.Many2one(
        ...
        help="This field contains the information related to the numbering of "
             "the journal entries of this journal.",
        copy=False,
    )
    refund_sequence_id = fields.Many2one(
        ...
        help="This field contains the information related to the numbering of "
             "the credit note entries of this journal.",
        copy=False,
    )
    ...
    @api.depends('refund_sequence', 'refund_sequence_id.use_date_range',
                 'refund_sequence_id.number_next_actual')
    def _compute_refund_seq_number_next(self):
        """Compute 'refund_sequence_number_next' according to the current sequence
