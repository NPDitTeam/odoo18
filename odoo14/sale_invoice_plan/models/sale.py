...
class SaleOrder(models.Model):
    ...
    def _next_date(self, installment_date, interval, interval_type):
        if isinstance(installment_date, str):
...
class SaleInvoicePlan(models.Model):
    ...
    def _compute_last(self):
        for rec in self:
            installments = rec.sale_id.invoice_plan_ids.mapped("installment")
            rec.last = installments and rec.installment == max(installments)
